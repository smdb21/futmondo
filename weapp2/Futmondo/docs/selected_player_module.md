...
Displays the name of the user who placed the incoming offer. When the offer is generated by the Futmondo system (detected by `userTeam.name == ""`), the column displays `"Computer / System"` instead.
